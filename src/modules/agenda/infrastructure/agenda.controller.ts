...
export class AgendaController {
  ...
  @ApiOperation({ summary: 'Get doctor schedule templates by professional ID' })
  findScheduleByProfessional(@Param('professionalId') professionalId: string) {
    return this.service.findScheduleByProfessional(professionalId);
  }
}
