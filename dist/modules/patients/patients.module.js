...
const patients_controller_1 = require("./infrastructure/patients.controller");
const patients_service_1 = require("./application/patients.service");
...
exports.PatientsModule = PatientsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([patient_entity_1.Patient, person_entity_1.Person])],
        controllers: [patients_controller_1.PatientsController],
        providers: [patients_service_1.PatientsService],
        exports: [typeorm_1.TypeOrmModule, patients_service_1.PatientsService],
    })
], PatientsModule);
