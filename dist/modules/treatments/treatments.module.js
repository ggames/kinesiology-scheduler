...
const treatment_entity_1 = require("./domain/treatment.entity");
const treatments_controller_1 = require("./infrastructure/treatments.controller");
...
exports.TreatmentsModule = TreatmentsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([treatment_entity_1.Treatment])],
        controllers: [treatments_controller_1.TreatmentsController],
        providers: [treatments_service_1.TreatmentsService],
        exports: [typeorm_1.TypeOrmModule, treatments_service_1.TreatmentsService]
    })
], TreatmentsModule);
