...
const resource_entity_1 = require("./domain/resource.entity");
const resources_controller_1 = require("./infrastructure/resources.controller");
...
exports.ResourcesModule = ResourcesModule = __decorate([
    (0, common_1.Module)({
        ...
        exports: [typeorm_1.TypeOrmModule, resources_service_1.ResourcesService]
    })
], ResourcesModule);
