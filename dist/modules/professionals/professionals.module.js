...
const professionals_controller_1 = require("./infrastructure/professionals.controller");
...
exports.ProfessionalsModule = ProfessionalsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([professional_entity_1.Professional, person_entity_1.Person])],
        controllers: [professionals_controller_1.ProfessionalsController],
        providers: [professionals_service_1.ProfessionalsService],
        exports: [typeorm_1.TypeOrmModule, professionals_service_1.ProfessionalsService],
    })
], ProfessionalsModule);
