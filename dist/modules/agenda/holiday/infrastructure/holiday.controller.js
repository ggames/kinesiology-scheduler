...
const holiday_service_1 = require("../application/services/holiday.service");
const create_holiday_dto_1 = require("../application/dto/create-holiday.dto");
...
__decorate([
    ...
    openapi.ApiResponse({ status: 200, type: [require("../domain/holiday.entity").Holiday] }),
...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: create_holiday_dto_1.CreateHolidayDto }),
    openapi.ApiResponse({ status: 201, type: require("../domain/holiday.entity").Holiday }),
...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: create_holiday_dto_1.UpdateHolidayDto }),
    openapi.ApiResponse({ status: 200, type: require("../domain/holiday.entity").Holiday }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, create_holiday_dto_1.UpdateHolidayDto]),
    __metadata("design:returntype", void 0)
