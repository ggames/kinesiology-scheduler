...
export declare class EventSubscribersLoader implements OnApplicationBootstrap, OnApplicationShutdown {
    ...
    constructor(discoveryService: DiscoveryService, eventEmitter: EventEmitter2, metadataAccessor: EventsMetadataAccessor, metadataScanner: MetadataScanner, moduleRef: ModuleRef, eventEmitterReadinessWatcher: EventEmitterReadinessWatcher, options?: EventEmitterModuleOptions);
